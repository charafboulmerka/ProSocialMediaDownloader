...
import static com.f08.prosaver.util.Utils.RootDirectorySnackVideoShow;

public class SnackVideoDownloadedFragment extends Fragment implements FileListClickInterface {
    private FragmentHistoryBinding binding;
    private FileListAdapter fileListAdapter;
    private ArrayList<File> fileArrayList;
    private GalleryActivity activity;
    public static SnackVideoDownloadedFragment newInstance(String param1) {
        SnackVideoDownloadedFragment fragment = new SnackVideoDownloadedFragment();
    ...
    private void getAllFiles(){
        ...
        if (files!=null) {
            ...
            fileListAdapter = new FileListAdapter(activity, fileArrayList, SnackVideoDownloadedFragment.this);
